...
public class DAOManhwa { // esta clase desaparece agregar descripciones mas largas y stock a cada manhwa
        ...
        public List<Manhwa> listaManhwas() {
                ...
                manhwas.add(
                                new Manhwa("13", "Dice: The Cube That Changes Everything",
                                                new Autor("Yun Hyunseok", "Corea del Sur"),
                                                new Genero(TiposGenero.SEINEN, "Psicologico/Fantasia"), "finalizado",
                                                4.1, 388));
